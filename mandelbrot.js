...
function main() {
    ...
    const handleInput = function (e) {
        ...
        let x_part, y_part;
        if (e.type === "mousedown") {
            x_part = e.offsetX / canvas_element.width;
            y_part = e.offsetY / canvas_element.height;
            zoom_factor = e.buttons & 1 ? 0.99 : 1.01;
        } else if (e.type === "touchstart") {
            let touch = e.touches[0];
            x_part = touch.clientX / canvas_element.width;
            y_part = touch.clientY / canvas_element.height;
